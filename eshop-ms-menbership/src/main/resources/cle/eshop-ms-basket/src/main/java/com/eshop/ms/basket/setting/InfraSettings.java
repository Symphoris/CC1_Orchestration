package com.eshop.ms.basket.setting;
...
public static KeyPair keyPairLoader() {
		...
		try (FileInputStream in = new FileInputStream("C://Users//etudiant//Documents//ING2//responsabilite_ing//Symphoris//A imprimer//ms-cours1//src//main//resources\\cle\\server.p12")){
